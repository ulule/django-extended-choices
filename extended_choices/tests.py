...
class ChoicesTestCase(BaseTestCase):
    ...
    def test_adding_choices(self):
        ...
        self.assertEqual(
            self.MY_CHOICES.entries[4].display, "... but Five is not in the song"
        )
        ...
        self.assertEqual(
            self.MY_CHOICES.constants["FOUR"], ("FOUR", 4, "And four to go")
        )
        self.assertEqual(
            self.MY_CHOICES.constants["FIVE"],
            ("FIVE", 5, "... but Five is not in the song"),
        )
        self.assertEqual(self.MY_CHOICES.values[4], ("FOUR", 4, "And four to go"))
        self.assertEqual(
            self.MY_CHOICES.values[5], ("FIVE", 5, "... but Five is not in the song")
        )
        self.assertEqual(
            self.MY_CHOICES.displays["And four to go"], ("FOUR", 4, "And four to go")
        )
        self.assertEqual(
            self.MY_CHOICES.displays["... but Five is not in the song"],
            ("FIVE", 5, "... but Five is not in the song"),
        )
    ...
    def test_extracting_subset(self):
        ...
        self.assertIs(subset.constants["ONE"], self.MY_CHOICES.constants["ONE"])
        self.assertIs(subset.constants["TWO"], self.MY_CHOICES.constants["TWO"])
        self.assertIs(subset.values[1], self.MY_CHOICES.constants["ONE"])
        self.assertIs(subset.values[2], self.MY_CHOICES.constants["TWO"])
        self.assertIs(
            subset.displays["One for the money"], self.MY_CHOICES.constants["ONE"]
        )
        self.assertIs(
            subset.displays["Two for the show"], self.MY_CHOICES.constants["TWO"]
        )
    ...
    def test_creating_subset(self):
        ...
        self.assertIs(
            self.MY_CHOICES.ODD.constants["ONE"], self.MY_CHOICES.constants["ONE"]
        )
        self.assertIs(
            self.MY_CHOICES.ODD.constants["THREE"], self.MY_CHOICES.constants["THREE"]
        )
        self.assertIs(self.MY_CHOICES.ODD.values[1], self.MY_CHOICES.constants["ONE"])
        self.assertIs(self.MY_CHOICES.ODD.values[3], self.MY_CHOICES.constants["THREE"])
        self.assertIs(
            self.MY_CHOICES.ODD.displays["One for the money"],
            self.MY_CHOICES.constants["ONE"],
        )
        self.assertIs(
            self.MY_CHOICES.ODD.displays["Three to get ready"],
    ...
    def test_for_methods(self):
        ...
        self.assertIs(
            self.MY_CHOICES.for_constant("ONE"), self.MY_CHOICES.constants["ONE"]
        )
        self.assertIs(self.MY_CHOICES.for_value(2), self.MY_CHOICES.values[2])
        self.assertIs(
            self.MY_CHOICES.for_display("Three to get ready"),
    ...
    def test_dict_class(self):
        ...
        dict_choices = Choices(("FOO", 1, "foo"), ("BAR", 2, "bar"))
        ...
        ordered_dict_choices = Choices(
            ("FOO", 1, "foo"), ("BAR", 2, "bar"), dict_class=OrderedDict
        )
...
class ChoiceAttributeMixinTestCase(BaseTestCase):
    ...
    def test_it_should_create_classes_on_the_fly(self):
        ...
        self.assertDictEqual(ChoiceAttributeMixin._classes_by_type, {int: IntClass})
        ...
        self.assertDictEqual(
            ChoiceAttributeMixin._classes_by_type, {int: IntClass, float: FloatClass}
        )
...
class ChoiceEntryTestCase(BaseTestCase):
    ...
    def test_new_attributes_are_instances_of_choices_attributes(self):
        ...
        # Extreme test
        self.assertIs(
            choice_entry.display.value.constant.value.display.display.constant,
...
class OldChoicesTestCase(BaseTestCase):
    ...
    def test_simple_choice(self):
        ...
        self.assertEqual(
            self.MY_CHOICES.CHOICES_CONST_DICT, {"ONE": 1, "TWO": 2, "THREE": 3}
        )

        # Get constant names from their values.
        self.assertEqual(
            self.MY_CHOICES.REVERTED_CHOICES_CONST_DICT,
            {1: "ONE", 2: "TWO", 3: "THREE"},
        )
    ...
    def test_retrocompatibility(self):
        ...
        OTHER_CHOICES = Choices(("TWO", 2, "Deux"), ("FOUR", 4, "Quatre"), name="EVEN")

        # ``add_choices`` will add some choices and set them in a new subset.
        OTHER_CHOICES.add_choices(
            "ODD",
            ("ONE", 1, "Un"),
            ("THREE", 3, "Trois"),
        )
        self.assertEqual(
            OTHER_CHOICES.CHOICES, ((2, "Deux"), (4, "Quatre"), (1, "Un"), (3, "Trois"))
        )
